...
function MotorCard({motorName, FloorNumber, AreaName,FactoryName}) {
  return (
    ...
    <div className='bg-white dark:bg-secondary-dark-bg
     h-48 rounded-xl w-72 px-2 m-3 shadow-md flex flex-col justify-center cursor-pointer'>
      ...
      <span className='mx-auto font-extrabold text-xl tracking-tight   text-slate-900  pb-5'>{motorName}</span>
      </div>
