...
function Alert({ bgColor50, textColor900,iconSrc, iconColor, message, alertsNumber, borderColor600, textColor500,borderColor500 }) {
  return (
    <div className={`ml-auto mr-3 flex flex-col gap-2 w-60 border-b-4 ${borderColor600}`}>
