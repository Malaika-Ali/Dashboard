...
function Alert({ bgColor50, textColor900,iconSrc, iconColor, message, alertsNumber, borderColor600, textColor500,borderColor500, onClick }) {
  return (
    <div className={`flex flex-col gap-2 md:w-52 lg:w-60 large:w-72 border-b-4 ${borderColor600} cursor-pointer lato-regular-16 font-bold large:text-xl`} onClick={onClick}>
