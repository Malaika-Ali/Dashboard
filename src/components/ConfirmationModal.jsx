...
// function ConfirmationModal({closeConfirmation}) {
//     return (
//       <>
//           <div
//       className=" overflow-y-auto inset-0 bg-opacity-50 bg-gray-800
//        overflow-x-hidden fixed top-50 right-0  z-50  backdrop-blur-sm justify-center items-center w-full md:inset-0 h-modal md:h-full"
//       tabIndex="-1"
//       aria-hidden="true"
//     >
...
function ConfirmationModal({closeConfirmation, user_name}) {
  return (
