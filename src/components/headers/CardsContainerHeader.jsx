...
function CardsContainerHeader({headingName, name, onAddButton, onDeleteButton,onSortButton, role }) {
  return (
    <div className="flex flex-row justify-between mt-10 m-5 sm:mt-16 large:mt-16 large:w-[94%]">
    <h1 className='header-heading md:text-xl lg:text-xl main-font large:text-3xl font-semibold' >{headingName}</h1>
