...
const TotalNumberCard = ({iconSrc, placeName, quantity, onClick}) => {
  return (
    <div className='bg-white h-32 rounded-xl w-[15rem] p-5  m-3 dark-box-shadow flex flex-col gap-2 lg:flex-nowrap justify-center items-center cursor-pointer large:w-[20rem] large:h-40 large:gap-4 large:text-2xl' onClick={onClick}>
